        ...
        <div className='md:h-full pt-61 md:pt-0'>
            ...
            <>
                <div className='md:h-full flex flex-col justify-start items-stretch w-full pt-10 mb-5 md:mb-0 sticky top-61 md:static'>
                    ...
                    >
                        <SwiperSlide className='w-70 h-42 max-w-70 max-h-42 cursor-pointer md:w-122 md:h-122 bg-white md:max-w-122 md:max-h-122'><img className='w-70 h-42 max-w-70 max-h-42 md:w-122 md:h-122 md:max-w-122 md:max-h-122 object-contain' src={product.image} alt="" /></SwiperSlide>
                        <SwiperSlide className='w-70 h-42 max-w-70 max-h-42 cursor-pointer md:w-122 md:h-122 bg-white md:max-w-122 md:max-h-122'><img className='w-70 h-42 max-w-70 max-h-42 md:w-122 md:h-122 md:max-w-122 md:max-h-122 object-contain' src={product.image} alt="" /></SwiperSlide>
                    </Swiper>
                </div>
                <div>
